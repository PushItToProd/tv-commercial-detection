...
NETWORK_LOGO_PATHS = {
    ...
    "fs1_nhra": logo_match.LOGOS_DIR / "fs1_nhra_logo.png",
}
...
def _has_network_logo(img: cv2.typing.MatLike, masked_logo: cv2.typing.MatLike) -> bool:
    ...
    masked_img_crop = logo_match.mask_non_white(img_crop)
...
def classify_image(image_path: str) -> ClassificationResult:
    ...
    return ClassificationResult(
        source="default", type="ad", reason="default_ad", reply="Defaulting to ad break (no network logo detected)"
    )
